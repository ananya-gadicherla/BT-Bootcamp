# Retail Shopping - Coding Challenge 25 to 30
...
for i in range(1, n + 1):
    ...
    # Promotional discount on item
    if item_code == PROMO_CODE:
        promo_discount = item_total * 0.10
        item_total -= promo_discount
        print("Promotional Discount Applied (10%): ₹", promo_discount)

    grand_total += item_total
    total_quantity += quantity

    print("Item Total After Promo (if any): ₹", item_total)
